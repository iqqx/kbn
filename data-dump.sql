...
--
-- Host: localhost    Database: diabet
-- ------------------------------------------------------
...
(1,'Школа наставничества'),
(2,'Школа диа для родителей'),
(3,'Школа диа для подростков'),
(4,'Мероприятие'),
(5,'Dia Camp');
...
-- Dump completed on 2025-06-13 18:28:39
